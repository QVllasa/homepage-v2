 ...
 */
final class Version20201009203633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banner DROP updated_at');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banner ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
    }
}
